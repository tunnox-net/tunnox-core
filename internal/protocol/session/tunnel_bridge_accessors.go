...
// GetTunnelID 获取隧道ID（实现 ITunnelBridgeAccessor 接口）
...
// GetSourceConnectionID 获取源连接ID（实现 ITunnelBridgeAccessor 接口）
...
// GetTargetConnectionID 获取目标连接ID（实现 ITunnelBridgeAccessor 接口）
...
// GetMappingID 获取映射ID（实现 ITunnelBridgeAccessor 接口）
...
// GetClientID 获取客户端ID（实现 ITunnelBridgeAccessor 接口）
...
// IsActive 检查桥接是否活跃（实现 ITunnelBridgeAccessor 接口）
