...
// Set 设置键值对
func (j *Storage) Set(key string, value interface{}) error {
	j.mu.Lock()
	defer j.mu.Unlock()
...
// Get 获取值
func (j *Storage) Get(key string) (interface{}, error) {
	j.mu.RLock()
	defer j.mu.RUnlock()
...
// Delete 删除键
func (j *Storage) Delete(key string) error {
	j.mu.Lock()
	defer j.mu.Unlock()
...
// Exists 检查键是否存在
func (j *Storage) Exists(key string) (bool, error) {
	j.mu.RLock()
	defer j.mu.RUnlock()
...
// BatchSet 批量设置
func (j *Storage) BatchSet(items map[string]interface{}) error {
	j.mu.Lock()
	defer j.mu.Unlock()
...
// BatchGet 批量获取
func (j *Storage) BatchGet(keys []string) (map[string]interface{}, error) {
	j.mu.RLock()
	defer j.mu.RUnlock()
...
// BatchDelete 批量删除
func (j *Storage) BatchDelete(keys []string) error {
	j.mu.Lock()
	defer j.mu.Unlock()
...
// GetStats 获取统计信息
func (j *Storage) GetStats() map[string]interface{} {
	j.mu.RLock()
	defer j.mu.RUnlock()
