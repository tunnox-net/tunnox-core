...
func TestStorage_MemoryOnlyMode(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)

	// 纯内存模式：persistent = nil
	config := DefaultConfig()
	config.EnablePersistent = false

	storage := New(ctx, cache, nil, config)
	defer storage.Close()
...
func TestStorage_DataCategoryRecognition(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)
	config := DefaultConfig()
...
func TestStorage_RuntimeData(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)
	config := DefaultConfig()
...
func TestStorage_ExplicitMethods(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)
	config := DefaultConfig()
...
func TestStorage_ConfigUpdate(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)
	config := DefaultConfig()
...
func TestStorage_IsPersistentEnabled(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)
	...
	storage1 := New(ctx, cache, nil, config1)
...
func TestStorage_ListOperations(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)
	config := DefaultConfig()
...
func TestStorage_CounterOperations(t *testing.T) {
	ctx := context.Background()
	cache := memory.New(ctx)
	config := DefaultConfig()
