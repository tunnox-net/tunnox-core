...
func NewNodeService(nodeRepo repos.INodeRepository, idManager *idgen.IDManager, parentCtx context.Context) NodeService {
	service := &nodeService{
...
// NodeRegister 节点注册
func (s *nodeService) NodeRegister(req *models.NodeRegisterRequest) (*models.NodeRegisterResponse, error) {
	// 检查节点是否已存在
...
// NodeUnregister 节点注销
func (s *nodeService) NodeUnregister(req *models.NodeUnregisterRequest) error {
	// 检查节点是否存在
...
// NodeHeartbeat 节点心跳
func (s *nodeService) NodeHeartbeat(req *models.NodeHeartbeatRequest) (*models.NodeHeartbeatResponse, error) {
	// 获取节点信息
...
func (s *nodeService) GetNodeServiceInfo(nodeID string) (*models.NodeServiceInfo, error) {
...
func (s *nodeService) GetAllNodeServiceInfo() ([]*models.NodeServiceInfo, error) {
