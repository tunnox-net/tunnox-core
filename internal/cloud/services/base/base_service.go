...
func (s *Service) HandleErrorWithIDRelease(err error, id interface{}, releaseFunc func(interface{}) error, message string) error {
	if err == nil {
		return nil
	}
...
func (s *Service) HandleErrorWithIDReleaseInt64(err error, id int64, releaseFunc func(int64) error, message string) error {
	if err == nil {
		return nil
	}
...
func (s *Service) HandleErrorWithIDReleaseString(err error, id string, releaseFunc func(string) error, message string) error {
	if err == nil {
		return nil
	}
...
func (s *Service) WrapError(err error, operation string) error {
	if err == nil {
		return nil
	}
	errCode := errors.GetCode(err)
...
func (s *Service) WrapErrorWithID(err error, operation, id string) error {
	if err == nil {
		return nil
	}
	errCode := errors.GetCode(err)
...
func (s *Service) WrapErrorWithInt64ID(err error, operation string, id int64) error {
	if err == nil {
		return nil
	}
	errCode := errors.GetCode(err)
...
// LogCreated 记录创建成功日志
func (s *Service) LogCreated(resourceType, identifier string) {
	corelog.Infof("Created %s: %s", resourceType, identifier)
}

// LogUpdated 记录更新成功日志
func (s *Service) LogUpdated(resourceType, identifier string) {
	corelog.Infof("Updated %s: %s", resourceType, identifier)
}

// LogDeleted 记录删除成功日志
func (s *Service) LogDeleted(resourceType, identifier string) {
...
// SetTimestamps 设置时间戳
func (s *Service) SetTimestamps(createdAt, updatedAt *time.Time) {
	now := time.Now()
	if createdAt != nil {
		*createdAt = now
	}
...
func (s *Service) SetUpdatedTimestamp(updatedAt *time.Time) {
	if updatedAt != nil {
		*updatedAt = time.Now()
	}
}
...
func NewSimpleStatsProvider(stor storage.Storage, parentCtx context.Context) (StatsProvider, error) {
	counter, err := stats.NewStatsCounter(stor, parentCtx)
	if err != nil {
